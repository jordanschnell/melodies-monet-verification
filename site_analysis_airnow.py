...
region_name = ["R1", "R2", "R3", "R4", "R5", "R6", "R7", "R8", "R9", "R10", "CA", "USEPA", "DSBR", "DSBH", "DSBN", "DSCD","DSGH", "DSGV", "DSMA", "DSMY","DSAG","DSBK","MX","DSPK","DSQA","DSRW","DSSG","DSTI","DSNI","DSTO","DSCH","DSET","DSAE","DSUB","DSIN","DSUG","DSKU","DSNP","DSMX","DSVN","DSCH","DSKV","DSUZ","DSAJ","DSIV","DSKZ","DSML","DSLA","DSEG","DSBG"]
region_type = ["epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region","epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region","epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region","epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region","epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region", "epa_region"]
...
for i in xregion:
    ...
    elif site_lat < 0 or site_lat > 75 or site_lon < -170 or site_lon > -30:
#    elif site_lat < 35 or site_lat > 70 or site_lon < -140 or site_lon > -105:
        continue

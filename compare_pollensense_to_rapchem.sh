...
# Average them and manipulate dims
...
# Here we create the 2-day forecast file only
...
# Now plot it
forecast=0
python ${SCRIPTS_DIR}/plot_compare_pollensense_to_rapchem2.py ${forecast} ${obs_path} ${model_dir} ${YYYYyt}${MMyt}${DDyt} ${YYYY}${MM}${DD} ${YYYYt}${MMt}${DDt} ${cycleHH} ${output_directory}
#
forecast=1
python ${SCRIPTS_DIR}/plot_compare_pollensense_to_rapchem2.py ${forecast} ${obs_path} ${model_dir} ${YYYYyt}${MMyt}${DDyt} ${YYYY}${MM}${DD} ${YYYYt}${MMt}${DDt} ${cycleHH} ${output_directory}
#

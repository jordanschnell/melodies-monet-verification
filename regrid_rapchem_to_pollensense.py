...
dest_file = '/scratch4/BMC/acomp/cheMPAS-Fire/realtime/rap-chem/homebasedir/static/WRF_INPUT/pollensense_30km_latlon.nc'
...
#print(regridder)
regridded_data = regridder(source_fid[['polp','polp_tree','polp_weed','polp_grass','pols','T','P','PB']])
